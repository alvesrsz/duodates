...
$nome_categoria = 'Restaurantes e Cafés';
...
<head>
    ...
    <title>DuoDates - Restaurantes e Cafés</title>
...
<body>
    ...
    <main class="container">
        <section class="page-title">
            <h2>Restaurantes e Cafés</h2>
            <p>Sugestões de locais charmosos para um encontro saboroso em Brasília.</p>
        </section>
