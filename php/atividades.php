...
// 1. NOME DA CATEGORIA
$nome_categoria = 'Atividades Diferentes';
...
$defaultPlaceholderUrl = "../images/placeholder_local.png"; // Imagem padrão
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
...
<body>
    ...
    <main class="container">
        <section class="page-title">
            ...
            <p>Para casais que querem sair da rotina e criar memórias inesquecíveis.</p>
        </section>
