...
$nome_categoria = 'Encontros com Música';
...
<head>
    ...
    <title>DuoDates - Encontros com Música</title>
...
<body>
    ...
    <main class="container">
        <section class="page-title">
            <h2>Encontros com Música</h2>
            <p>Deixe o som criar o clima perfeito para o encontro em Brasília.</p>
        </section>
