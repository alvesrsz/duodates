...
$nome_categoria = 'Relaxamento e Bem-estar'; 
...
<head>
    ...
    <title>DuoDates - Relaxamento e Bem-estar</title>
...
<body>
    ...
    <main class="container">
        <section class="page-title">
            <h2>Relaxamento e Bem-estar</h2>
            <p>Sugestões para desacelerar, cuidar do corpo e da mente a dois em Brasília.</p>
        </section>
